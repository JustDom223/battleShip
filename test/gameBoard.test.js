...
describe('GameBoard', () => {
    ...
    describe('Node Targeting', () => {
        ...
        test('If a node contains a ship then the players ship will be hit. Also I have added the render function here to see how that performs', () => {
            gameBoard.attack('0,1');
            gameBoard.attack('1,1');
            gameBoard.attack('0,4');
            //Checking that the render is accurate
            gameBoard.renderBoard(true);

            expect(player1.ships[0].health).toBe(3);
        });
    });
});
